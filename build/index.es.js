import React__default, { useCallback, useRef, useLayoutEffect, useEffect, useMemo, useState, cloneElement, createElement, forwardRef, Fragment as Fragment$1 } from 'react';
...
var ValueLabel$1 = withStyles$1(styles, {
...
var Slider = forwardRef(function Slider(props, ref) {
  ...
  var touchId = useRef(); // We can't use the :active browser pseudo-classes.
  ...
  return createElement(Component, _extends({
    ...
    return createElement(Fragment$1, {
      key: mark.value
    }, createElement("span", {
      style: style,
    ...
    var style = axisProps[axis].offset(percent);
    return createElement(ValueLabelComponent, {
      key: index,
...
var Slider$1 = withStyles$1(styles$1, {
  name: 'MuiSlider'
})(Slider);

var MyComponent = function () { return (createElement(Slider$1, null)
// <div>Some text</div>
); };
